...
public class PathRepositoryImpl implements PathRepository {
    private static final RowMapper<PathEntity> ROW_MAPPER = BeanPropertyRowMapper.newInstance(PathEntity.class);
